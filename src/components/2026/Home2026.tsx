    ...
    <div className="bg-white text-[#1a1a1a]">
      ...
      <section className="bg-[#7d0b1c] text-white">
        <div className="max-w-[1100px] mx-auto px-6 md:px-10 py-20 md:py-28 text-center">
          <p className="tracking-[3px] text-[13px] text-white/70 mb-3">{c.themeBand.eyebrow}</p>
          <h2 className="text-[clamp(28px,6vw,56px)] font-extrabold">{c.themeBand.title}</h2>
          <div className="w-[clamp(180px,40vw,860px)] h-px bg-white/30 mx-auto my-7" />
          <p className="text-white/90 max-w-[820px] mx-auto leading-relaxed text-[16px]">{c.themeBand.desc1}</p>
          <p className="text-white/90 max-w-[820px] mx-auto leading-relaxed text-[16px] mt-2">{c.themeBand.desc2}</p>
          <p className="text-white/90 max-w-[820px] mx-auto leading-relaxed text-[16px] mt-2">{c.themeBand.desc3}</p>
          <p className="tracking-[6px] text-[#e7c9a0] font-semibold mt-12 mb-8 text-[15px]">{c.themeBand.notesTitle}</p>
