      ...
      <div className="overflow-hidden" ref={emblaRef}>
        <div className="flex my-1">
          {companies.map((company, index) => (
            ...
            >
              <div className="group flex h-full flex-col rounded-2xl border overflow-hidden border-white/15 bg-[#121212]/70 shadow-md transition-[transform,border-color] duration-300 hover:-translate-y-1 hover:border-[#ea5514]/70">
                <div className="relative h-[280px] md:h-[282px]  bg-[#1a1a1a] flex items-center justify-center p-4">
                  <Image
